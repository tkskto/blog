...
export default {
    ...
    head() {
        return {
            ...
            meta: [
                { hid: 'description', name: 'description', content: `This is an article about ${this.title}.` },
                ...
                { hid: 'og:description', property: 'og:description', content: `This is an article about ${this.title}.` },
